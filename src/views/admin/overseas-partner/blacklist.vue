  ...
  <div class="manageMent m-20">
    ...
    <div class="p-20 bg-white" v-if="homeViewIndex === 1">
      ...
      >
        ...
        <el-table-column prop="address" label="所属级别" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="name" label="归属合伙人" width="120">
          <template slot-scope="scope">
            ...
            ><el-button @click="lookPartner(scope.row)" type="text" size="small"
              >查看</el-button
            >
          </template>
        </el-table-column>
        <el-table-column prop="name" label="归属会员" width="120">
          <template slot-scope="scope">
            <span>{{ scope.row.name }}</span
            ><el-button @click="lookMembers(scope.row)" type="text" size="small"
              >查看</el-button
            >
          </template>
        </el-table-column>
    ...
    <blank-Member ref="blankMember"></blank-Member>
    <el-dialog
      title="设为白名单"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="setBlankList = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
import blankMember from "./components/blankMemberProp";
import partnerInfo from "./components/partnerInfo";
import pages from "@/components/Pagination";
export default {
  components: { blankMember, partnerProp, pages, partnerInfo },
  data() {
    return {
      expireTimeOption: {
        disabledDate(date) {
  ...
  methods: {
    ...
    lookMembers(value) {
      //归属会员
      console.log("会员");
      this.$refs.blankMember.$emit("showProp", value);
    },
    changePage(obj) {
      //console.log(obj)
    },
