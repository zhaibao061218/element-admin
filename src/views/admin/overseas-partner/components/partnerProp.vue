    ...
    >
      ...
      >
        ...
        <el-form-item label="归属级别" prop="region">
          <el-select v-model="partnerForm.region" placeholder="请选择">
      ...
      <div v-show="showView === 1" class="tableBorder">
        <el-table :data="gridData">
          <el-table-column property="date" label="我的合伙人"></el-table-column>
      ...
      <div v-show="showView === 2" class="tableBorder">
        ...
        <el-table :data="gridData">
          <el-table-column property="date" label="下级合伙人"></el-table-column>
          <el-table-column property="name" label="所属级别"></el-table-column>
          <el-table-column property="name" label="合伙人状态"></el-table-column>
          <el-table-column property="name" label="注册时间"></el-table-column>
        </el-table>
